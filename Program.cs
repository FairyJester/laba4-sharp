...
namespace Lab4_sharp
{
    class Program
    {
        ...
        {
            Student[] students = {
                new Student("Smit", "G", "B", "20rt45", new int [5]{3, 4, 5, 5, 2}),
                new Student("Gorshinev", "M", "Yu", "20rt45", new int [5]{5, 4, 5, 5, 3}),
                new Student("Shamto", "J", "D", "20rt45", new int [5]{3, 4, 5, 5, 2}),
                new Student("Korol", "B", "G", "20rt45", new int [5]{3, 4, 5, 5, 2}),
                new Student("Durov", "P", "V", "20rt45", new int [5]{3, 4, 5, 5, 2}),
                new Student("Mikhotin", "I", "A", "20rt45", new int [5]{3, 4, 5, 5, 2})};
